...
if __name__ == '__main__':
    ...
    tag = 'origin'
    writer = SummaryWriter(log_dir='summary/lane-detect-%s-%s' % (train_start_time, tag))
        ...
        try:
            ...
            if phase == 'train':
                ...
                if epoch % ckpt_epoch_interval == 0:
                    ckpt_dir = 'check_point/ckpt_%s_%s' % (train_start_time, tag)
