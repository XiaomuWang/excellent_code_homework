...
if __name__ == '__main__':
    ...
    # test_set = TuSimpleDataset(r'D:\tusimple\test_set', phase='test')
    # train_set = TuSimpleDataset(r'D:\tusimple\train_set', phase='train')
    val_set = TuSimpleDataset(r'D:\tusimple\train_set', phase='val')
