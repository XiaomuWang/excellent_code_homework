...
if __name__ == '__main__':
    ...
    test_set = TuSimpleDataset('./tusimple/test_set', phase='test')
    train_set = TuSimpleDataset('./tusimple/train_set', phase='train')
    val_set = TuSimpleDataset('./tusimple/train_set', phase='val')
