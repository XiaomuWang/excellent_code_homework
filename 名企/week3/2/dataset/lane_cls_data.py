...
class LaneClsDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        mask_bg = np.all(mask_image == self.BACKGROUND_COLOR, axis=2)
...
if __name__ == "__main__":
    d = LaneClsDataset(list_path='/media/berney/Media/road_fcn/full.tsv',
                       dir_path='/media/berney/Media/road_fcn/data_road')
